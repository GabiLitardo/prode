...
for idx_g, (nombre_grupo, equipos) in enumerate(grupos_data.items()):
    ...
    with cols_grupos[idx_g % 3]:
        ...
        # Almacenar el 3ro para el búnker general de desempate
...
# Determinación de los 8 mejores
...
# Matriz oficial de opciones reglamentarias (Opciones válidas por Partido)
...
# Asignación inteligente dinámica por descarte
...
# Estructura de llaves fija de la FIFA para el Mundial 2026
